...
func NewRouter(d Deps) http.Handler {
	...
	inst("GET /api/v1/instances/{id}/icon", auth.ActionConfigWrite, s.getServerIcon)
	inst("PUT /api/v1/instances/{id}/icon", auth.ActionConfigWrite, s.putServerIcon)
	inst("DELETE /api/v1/instances/{id}/icon", auth.ActionConfigWrite, s.deleteServerIcon)
